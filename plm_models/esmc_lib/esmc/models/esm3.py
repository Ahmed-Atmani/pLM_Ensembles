...
from esmc.models.vqvae import StructureTokenDecoder, StructureTokenEncoder
from esmc.sdk.api import (
    ESM3InferenceClient,
    ESMProtein,
    ESMProteinTensor,
...
from esmc.utils import encoding
from esmc.utils.constants import esm3 as C
from esmc.utils.constants.models import ESM3_OPEN_SMALL, normalize_model_name
from esmc.utils.decoding import decode_protein_tensor
from esmc.utils.generation import (
    _batch_forward,
    _sample_per_prompt,
...
from esmc.utils.misc import rbf
from esmc.utils.sampling import (
    _BatchedESMProteinTensor,
    get_default_sampling_config,
    validate_sampling_config,
)
from esmc.utils.structure.affine3d import build_affine3d_from_coordinates
...
class ESM3(nn.Module, ESM3InferenceClient):
    ...
    def from_pretrained(
        ...
        from esmc.pretrained import load_local_model
