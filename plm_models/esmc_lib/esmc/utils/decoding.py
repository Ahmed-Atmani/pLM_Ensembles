...
from esmc.models.function_decoder import FunctionTokenDecoder
from esmc.models.vqvae import StructureTokenDecoder
from esmc.sdk.api import ESMProtein, ESMProteinTensor
from esmc.tokenization import TokenizerCollectionProtocol
from esmc.tokenization.function_tokenizer import InterProQuantizedTokenizer
from esmc.tokenization.residue_tokenizer import ResidueAnnotationsTokenizer
from esmc.tokenization.sasa_tokenizer import SASADiscretizingTokenizer
from esmc.tokenization.sequence_tokenizer import EsmSequenceTokenizer
from esmc.tokenization.ss_tokenizer import SecondaryStructureTokenizer
from esmc.tokenization.structure_tokenizer import StructureTokenizer
from esmc.tokenization.tokenizer_base import EsmTokenizerBase
from esmc.utils.constants import api as api_constants
from esmc.utils.constants import esm3 as C
from esmc.utils.function.encode_decode import (
    decode_function_tokens,
    decode_residue_annotation_tokens,
)
from esmc.utils.misc import maybe_list
from esmc.utils.structure.protein_chain import ProteinChain
from esmc.utils.types import FunctionAnnotation
