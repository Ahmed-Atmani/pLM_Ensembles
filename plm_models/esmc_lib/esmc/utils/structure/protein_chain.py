...
from esmc.utils import residue_constants
from esmc.utils.misc import slice_python_object_as_numpy
from esmc.utils.structure.affine3d import Affine3D
from esmc.utils.structure.aligner import Aligner
from esmc.utils.structure.atom_indexer import AtomIndexer
from esmc.utils.structure.metrics import compute_gdt_ts, compute_lddt_ca
from esmc.utils.structure.mmcif_parsing import MmcifWrapper, Residue
from esmc.utils.structure.normalize_coordinates import (
    apply_frame_to_coords,
    get_protein_normalization_frame,
)
from esmc.utils.structure.protein_structure import index_by_atom_name
from esmc.utils.types import PathOrBuffer
