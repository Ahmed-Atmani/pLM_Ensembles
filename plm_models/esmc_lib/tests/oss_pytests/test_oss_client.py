...
from esmc.sdk import client  # pyright: ignore
from esmc.sdk.api import (  # pyright: ignore
    ESMProtein,
    ESMProteinTensor,
...
from esmc.sdk.forge import SequenceStructureForgeInferenceClient  # pyright: ignore
